    ...
    <nav className="w-full flex justify-between items-center p-4 sm:p-6 lg:px-24 sticky top-0 z-40 bg-(--secondary)/80 backdrop-blur-md border-b-2 border-(--border) shadow-sm">
      ...
      >
        ...
        <div className="flex flex-col -space-y-0.5 sm:-space-y-1">
          <span className="text-lg sm:text-2xl font-serif font-black text-(--tertiary) tracking-tighter uppercase leading-none">
            Memory <span className="text-(--primary) italic lowercase font-normal ml-0.5">Archive</span>
          </span>
          <span className="text-[8px] sm:text-[10px] uppercase tracking-[0.3em] sm:tracking-[0.4em] text-(--tertiary)/40 font-bold">Registry of Souls</span>
        </div>
      </div>

      <div>
        <button
          className="btn-primary flex items-center gap-2 px-3 sm:px-6 py-2 text-sm sm:text-base"
